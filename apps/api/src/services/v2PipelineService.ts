      ...
      image_prompt_candidates: [
        {
          ...
          prompt: [
            ...
            "【场景环境】选择一个能制造强烈需求或痛点的真实生活场景，例如炎热、疲惫、忙碌、尴尬或低效瞬间。",
            "【构图与镜头】中近景或特写构图，主体位于视觉中心，背景保留少量环境信息，方便后续叠加大字标题。",
            "【光线与色彩】痛点侧使用偏暖、偏压迫的色调；为后续产品转场预留冷色或高亮对比。",
            "【质感与风格】写实商业广告质感，画面清晰，细节可信，有强停留感。",
            "【画面内容】突出用户正在面临的购买风险、使用痛点或强需求，让观众 1 秒内理解问题。",
      ...
      video_prompt_candidates: [
        {
          ...
          prompt: [
            ...
            "【主体动作】强化用户痛点或需求瞬间，例如表情变化、手部动作、物体震动、水珠滑落等。",
            ...
            "【避免事项】不要新增无关品牌或复杂人物；不要让画面变形；不要复制样例视频具体镜头。"
          ].join("\n")
        },
        {
