      ...
      image_prompt_candidates: [
        {
          ...
          prompt: [
            ...
            "【候选图要求】请为该槽位生成 3 张候选图供用户选择，三张图保持同一广告意图，但在构图、光线、景别或背景细节上有差异。",
            `【主体/产品】面向“${audience}”，画面需要暗示${productName}即将作为解决方案出现，但不要直接复制样例广告品牌或场景。`,
            "【场景环境】选择一个能制造强烈需求或痛点的真实生活场景，例如炎热、疲惫、忙碌、尴尬或低效瞬间；如果用户素材里没有人物，优先用环境、物品、手部动作或局部状态表达痛点。",
        ...
        },
        {
          ...
          prompt: [
            ...
            "【候选图要求】请为该槽位生成 3 张候选图供用户选择，三张图保持同一产品设定，但在产品角度、光线、背景和景别上有差异。",
        ...
        },
        {
          ...
          prompt: [
            ...
            "【候选图要求】请为该槽位生成 3 张候选图供用户选择，三张图保持同一对比逻辑，但在分屏形式、构图和光线氛围上有差异。",
